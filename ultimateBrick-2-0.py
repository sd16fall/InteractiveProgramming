...
- Version 2.1 (est. 9 hours) (semi-complete)
    - Support 2P generation (multiplayer) - done -
    - Develop competitive elements (inter-player sprite interaction) - done -
    - Addition of flash screen for instructions (completed but function is muted)
    - In-game restart capability (breaks interaction) (functionality muted due to infinite restart)
    - Complete classic game mode
...
def restartprompt():
    ...
    text = bigfont.render("Restart", 13, (0, 0, 0))
    textx = SCREEN_WIDTH / 2 - text.get_width() / 2
    texty = SCREEN_HEIGHT / 2+10 - text.get_height() / 2
...
# Splash screen appears - function has geometry problems, can render
#showStartScreen()
