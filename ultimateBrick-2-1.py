...
- Version 2.1 (est. 9 hours) (90 percent complete)
    - Support 2P generation (multiplayer) - done -
    - Develop competitive elements (inter-player sprite interaction) - done -
    - Addition of flash screen for instructions - done -
    - In-game restart capability (breaks interaction) (functionality muted due to infinity bug)
    - Complete classic game mode - done -
